...
async function fetchReviews() {
    const response = await fetch('https://raw.githubusercontent.com/blockchainbazaar/blockchainbazaar.github.io/main/static/data/reviews.json'); // Path to your JSON file
